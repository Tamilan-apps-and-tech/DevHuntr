...
import {XamarinDocsContext} from "../../../data/Docs/XamarinDocsContext";
import XamarinDocsCard from "./XamarinDocsCard";

function AndroidDocsList(props) {

    const [docs, setDocs] = useContext(XamarinDocsContext)
