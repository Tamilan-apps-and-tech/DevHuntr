...
import DotnetDocsCard from "./DotnetDocsCard";
import Loading from "../../Loading";
import PageSwitcher from "../../PageSwitcher";
import {PageContext} from "../../../data/PageContext";
import {LoadingContext} from "../../../data/LoadingContext";
import {DotnetDocsContext} from "../../../data/Docs/DotnetDocsContext";
import NoResult from "../../NoResult";

function AndroidDocsList(props) {

    const [docs, setDocs] = useContext(DotnetDocsContext)
