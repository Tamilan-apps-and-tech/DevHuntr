...
function ReactNativeDocsCard(props) {
        ...
        return (
            <div
                ...
                <h1 className='font-montserrat mb-2 text-orange-chip mt-2  text-xl ml-6'>{props.item.linkRef}</h1>
            </div>
        );
...
export default ReactNativeDocsCard;